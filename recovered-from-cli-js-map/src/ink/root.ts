...
export async function createRoot({
  ...
  await Promise.resolve()
  try {
    appendFileSync('D:/work/web/anthropic-ai-claude-code-2.1.88/recovered-from-cli-js-map/.codex-runtime/interactive-trace.log', `${new Date().toISOString()} ink-root: before new Ink\n`)
  } catch {}
  ...
  try {
    appendFileSync('D:/work/web/anthropic-ai-claude-code-2.1.88/recovered-from-cli-js-map/.codex-runtime/interactive-trace.log', `${new Date().toISOString()} ink-root: after new Ink\n`)
  } catch {}
  ...
  try {
    appendFileSync('D:/work/web/anthropic-ai-claude-code-2.1.88/recovered-from-cli-js-map/.codex-runtime/interactive-trace.log', `${new Date().toISOString()} ink-root: after instances.set\n`)
  } catch {}
