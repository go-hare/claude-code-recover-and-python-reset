...
export async function renderAndRun(root: Root, element: React.ReactNode): Promise<void> {
  try {
    appendFileSync('D:/work/web/anthropic-ai-claude-code-2.1.88/recovered-from-cli-js-map/.codex-runtime/interactive-trace.log', `${new Date().toISOString()} interactiveHelpers: before root.render\n`);
  } catch {}
  root.render(element);
  try {
    appendFileSync('D:/work/web/anthropic-ai-claude-code-2.1.88/recovered-from-cli-js-map/.codex-runtime/interactive-trace.log', `${new Date().toISOString()} interactiveHelpers: after root.render\n`);
  } catch {}
  startDeferredPrefetches();
  try {
    appendFileSync('D:/work/web/anthropic-ai-claude-code-2.1.88/recovered-from-cli-js-map/.codex-runtime/interactive-trace.log', `${new Date().toISOString()} interactiveHelpers: after startDeferredPrefetches\n`);
  } catch {}
